<template>
  <div>
    <div class="flex justify-center">
      ...
      <h1 class="text-white text-2xl leading-14 self-center font-bold font-sans">
        JDS Reservasi
      </h1>
    </div>
    <div class="mt-6 mx-24 py-1 w-16 h-16 bg-white rounded-full text-green-700 text-4xl font-bold font-sans text-center">
      {{ initialUserName }}
    </div>
    <div class="flex justify-center mt-3">
      <span class="font-medium text-white pr-4 text-center">{{ fullUserName }}</span>
    </div>
...
a.nuxt-link-exact-active, a.nuxt-link-active i {
  @apply bg-gray-200 text-green-700;
